...
The problem domain is discretized starting from a base hexahedron partitioned into tetrahedra, scaling the refinement to generate three distinct initial unstructured meshes: \texttt{mesh-cube-10}, \texttt{texttt{mesh-cube-20}}, and \texttt{mesh-cube-40}. 
